    ...
    <FlatList
      ...
      ListHeaderComponent={<View>
        ...
        <Card>
          ...
          {photoUri && <Card className="p-md"><Image source={{ uri: photoUri }} accessibilityLabel="Vista previa de la fotografía" className="w-full h-[180px] rounded-medium" /><AppButton title="Quitar vista previa" variant="ghost" onPress={() => { setPhotoUri(undefined); setPhotoPending(false); }} disabled={saving} /></Card>}
